...
static int lua_setCpuSpeedVHigh(lua_State *L)
{
	scePowerSetClockFrequency(333, 333, 166);
	return 0;
}

static int lua_setCpuSpeedHigh(lua_State *L)
{
	scePowerSetClockFrequency(300, 300, 150);
	return 0;
}

static int lua_setCpuSpeedMed(lua_State *L)
{
	scePowerSetClockFrequency(266, 266, 133);
	return 0;
}

static int lua_setCpuSpeedReg(lua_State *L)
{
	scePowerSetClockFrequency(222, 222, 111);
	return 0;
}

static int lua_setCpuSpeedLow(lua_State *L)
{
	scePowerSetClockFrequency(200, 200, 100);
	return 0;
}

static int lua_setCpuSpeedVLow(lua_State *L)
{
...
static const luaL_reg System_functions[] = {
  ...
  {"Quit",                          lua_Quit},
  {"setCpuSpeedVHigh",              lua_setCpuSpeedVHigh},
  {"setCpuSpeedHigh",               lua_setCpuSpeedHigh},
  {"setCpuSpeedMed",                lua_setCpuSpeedMed},
  {"setCpuSpeedReg",                lua_setCpuSpeedReg},
  {"setCpuSpeedLow",                lua_setCpuSpeedLow},
  {"setCpuSpeedVLow",               lua_setCpuSpeedVLow},
  {0, 0}
};
